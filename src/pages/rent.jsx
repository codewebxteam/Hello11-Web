...
import { Users, Fuel, Gauge, ChevronRight, X, User, MapPin, Navigation, Calendar } from 'lucide-react';
          ...
          {cars.map((car) => (
            ...
            >
              <div className="relative h-40 md:h-52 mb-4 overflow-hidden flex items-center justify-center">
                ...
                <img src={car.img} alt={car.name} className="w-full h-full object-contain relative z-10 group-hover:scale-110 transition-transform duration-700 pointer-events-none drop-shadow-2xl" />
              </div>
          ...
          >
            ...
            <div className="flex justify-between items-start mb-5">
              <div>
                ...
                <p className="text-yellow-500 font-black text-lg">₹{modal.price} <span className="text-gray-500 text-xs font-bold">/ day</span></p>
              </div>
