...
const INSTAGRAM_URL =
  "https://www.instagram.com/hello11.in?igsh=MWd2cTR6dzd0anJjZg==";
...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Facebook size={16} />, href: FACEBOOK_URL, label: "Facebook" },
    { icon: <Instagram size={16} />, href: INSTAGRAM_URL, label: "Instagram" },
    {
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
            ...
            <div className="space-y-4 w-full text-center md:text-left">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-1 md:gap-3 group">
                ...
                <a
                  ...
                  className="text-gray-500 hover:text-yellow-400 text-[9px] font-bold uppercase transition-colors"
                >
                  +91 96289 11211
                </a>
              </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col items-center gap-6">
          ...
          <div className="w-full flex flex-col items-center gap-3 mb-2">
            <p className="text-gray-500 text-[9px] font-bold uppercase tracking-[0.25em]">
              Available on Mobile
            </p>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-3 bg-yellow-400 hover:bg-yellow-300 text-black px-5 py-3 rounded-2xl font-black text-xs uppercase tracking-wider transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg shadow-yellow-400/10"
            >
              <svg
              ...
              <span className="bg-black/10 group-hover:bg-black/20 text-[9px] px-2 py-0.5 rounded-full font-black uppercase">
                Play Store
              </span>
            </a>
          </div>

          <div className="flex flex-col md:flex-row justify-between items-center w-full gap-3 border-b border-white/5 pb-6">
            ...
            <div className="flex items-center gap-2 bg-white/5 px-3 py-1 rounded-full border border-white/5">
              ...
              <span className="text-gray-600 text-[8px] font-black uppercase tracking-[0.1em]">
                All Systems Live
              </span>
            </div>
          </div>
          ...
          <div className="w-full text-center pb-4">
            <div className="flex flex-col items-center justify-center gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="relative group flex items-center gap-2 px-6 py-2.5 bg-yellow-400/5 hover:bg-yellow-400/10 rounded-full border border-yellow-400/20 transition-all duration-500 shadow-2xl"
              >
                <span className="text-yellow-400 font-black tracking-[0.15em] text-sm md:text-lg">
                  CODEWEBX
                </span>
                <motion.div
                  animate={{ y: [0, -3, 0] }}
                ...
                >
                  <ExternalLink
                    size={16}
                    className="text-yellow-400 group-hover:scale-125 transition-transform"
                  />
                </motion.div>

                {/* Visual link highlight */}
                <div className="absolute inset-0 bg-yellow-400/5 blur-xl rounded-full -z-10 group-hover:bg-yellow-400/10 transition-colors" />
              </a>
